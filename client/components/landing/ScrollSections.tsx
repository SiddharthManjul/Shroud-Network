      ...
      <div className="w-full h-full flex items-center justify-center">
        <div className="relative flex items-center justify-center">
          {[80, 120, 160, 200].map((size, i) => (
            <div
              key={size}
              className="absolute rounded-full border border-[#acf901]/20 animate-ping"
              style={{
                width: size,
                height: size,
          ...
          <div className="relative z-10 flex h-20 w-20 items-center justify-center rounded-full border border-[#acf901]/60 bg-[#acf901]/10">
            <svg viewBox="0 0 24 24" fill="none" stroke="#acf901" strokeWidth="1.5" className="w-10 h-10">
  ...
  },
  {
    ...
    visual: (
      <div className="w-full h-full flex items-center justify-center font-mono text-xs">
        <div className="space-y-1 text-[#acf901]/70">
          {[
            "commit(note) → leaf",
            ...
            <motion.div
              ...
              className="rounded border border-[#acf901]/20 bg-[#acf901]/5 px-3 py-1"
            >
              {line}
            </motion.div>
          ))}
      ...
      <div className="w-full h-full flex items-center justify-center">
        <div className="grid grid-cols-3 gap-3 w-full max-w-xs">
          {[
            ...
            <div
              key={label}
              className="flex flex-col items-center justify-center rounded border border-[#acf901]/20 bg-[#acf901]/5 p-3"
            >
              <span className="text-xl font-bold text-[#acf901]">{count}</span>
          ...
          {sections.map((section, index) => (
            ...
            >
              ...
              <div className="flex-1 space-y-6 text-center md:text-left">
                ...
                <h2 className="text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-linear-to-r from-[#acf901] to-[#ff6b6b]">
                  {section.headline}
                </h2>
              ...
              <div className="flex-1 w-full">
                <div
                  className="aspect-video overflow-hidden border border-[#acf901]/20 bg-[#0d0d0d] relative"
                  style={{
                    clipPath:
