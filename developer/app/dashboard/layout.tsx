    ...
    <div className="min-h-screen bg-black flex">
      ...
      <aside className="w-60 border-r border-[#2a2a2a] bg-[#0d0d0d] flex flex-col shrink-0">
        ...
        <div className="px-3 py-4 border-t border-[#2a2a2a] space-y-1">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 w-full rounded-lg px-3 py-2 text-sm font-medium text-[#888888] hover:text-[#acf901] hover:bg-[#acf901]/5 transition-colors duration-200"
          >
          ...
          <button
            ...
            className="flex items-center gap-3 w-full rounded-lg px-3 py-2 text-sm font-medium text-[#888888] hover:text-[#ff4444] hover:bg-[#ff4444]/5 transition-colors duration-200 cursor-pointer"
          >
