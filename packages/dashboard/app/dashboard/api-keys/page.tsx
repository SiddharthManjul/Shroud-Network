    ...
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className="flex items-center gap-2 rounded-lg bg-[#acf901] text-black px-4 py-2 text-sm font-semibold hover:bg-[#acf901]/90 transition-colors"
        >
        ...
        <div className="mb-6 rounded-lg border border-[#acf901]/30 bg-[#acf901]/5 p-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="shrink-0 rounded-lg border border-[#2a2a2a] bg-[#0d0d0d] p-2 text-[#888888] hover:text-[#acf901] transition-colors"
            >
              {copied ? (
          ...
          <button
            ...
            className="mt-2 text-xs text-[#888888] hover:text-[#acf901] transition-colors"
          >
            Dismiss
          </button>
        </div>
        ...
        <div className="mb-6 rounded-lg border border-[#2a2a2a] bg-[#0d0d0d] p-5">
          ...
          <div className="flex gap-3">
            <button
              ...
              disabled={creating}
              className="flex items-center gap-2 rounded-lg bg-[#acf901] text-black px-4 py-2 text-sm font-semibold hover:bg-[#acf901]/90 disabled:opacity-50 transition-colors"
            >
            ...
            <button
              ...
              className="rounded-lg border border-[#2a2a2a] px-4 py-2 text-sm text-[#888888] hover:text-white transition-colors"
            >
              Cancel
            </button>
          </div>
            ...
            >
              ...
              {k.isActive && (
                <button
                  ...
                  className="rounded-lg p-2 text-[#888888] hover:text-[#ff4444] hover:bg-[#ff4444]/5 transition-colors"
                  title="Revoke key"
                >
