    ...
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-[#acf901]">Create Account</h1>
          <p className="text-[#888888] mt-2">Get your Shroud API keys</p>
        </div>
        ...
        <div className="rounded-lg border border-[#2a2a2a] bg-[#0d0d0d] p-8">
          ...
          <p className="mt-6 text-center text-sm text-[#888888]">
            ...
            <Link href="/login" className="text-[#acf901] hover:underline">
              Sign in
            </Link>
          </p>
        </div>
